 ...
 *
 * <p>Extracts the JWT token from the query parameter "token" or "Authorization" header, validates
 * it, and stores the corresponding Authentication object in attributes. If the token is invalid or
 * missing, the handshake is rejected with HTTP 401.
 */
